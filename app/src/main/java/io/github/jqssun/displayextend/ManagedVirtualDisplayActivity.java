...
public class ManagedVirtualDisplayActivity extends AppCompatActivity {
  ...
  private static float[] _adjustTouchCoordinates(
      float x,
      float y,
      int rotation,
      int targetWidth,
        ...
        .addCallback(
            new SurfaceHolder.Callback() {
              ...
              public void surfaceCreated(SurfaceHolder holder) {
                ...
                if (State.managedVirtualDisplay == null) {
                  stopVirtualDisplay();
                  State.managedVirtualDisplay =
                      CreateVirtualDisplay.createVirtualDisplay(args, surface);
                ...
                if (State.currentActivity.get() instanceof MainActivity) {
                  ((MainActivity) State.currentActivity.get())
                      .navigateToDisplayDetail(jumpToDisplay.getDisplayId());
                }
              }
              ...
              public void surfaceDestroyed(SurfaceHolder holder) {
                if (State.managedVirtualDisplay != null) {
                  ...
                  keepAliveReader =
                      ImageReader.newInstance(args.width, args.height, PixelFormat.RGBA_8888, 2);
    ...
    surfaceView.setOnTouchListener(
        (v, event) -> {
          if (State.managedVirtualDisplay != null) {
            ...
            float[] adjustedCoords =
                _adjustTouchCoordinates(
                    x,
                    y,
                    rotation,
                    args.width,
