...
public class PresentManagedVirtualDisplay implements Job {
  ...
  public void start() throws YieldException {
    ...
    if (requestMediaProjectionPermission(
        State.currentActivity.get(), displayHidden.getType() == TYPE_WIFI)) {
  ...
  private boolean requestMediaProjectionPermission(Context context, boolean isWifiDisplay)
